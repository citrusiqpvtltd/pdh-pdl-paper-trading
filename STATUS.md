...
_Simulator only. No real money, no exchange account, no API keys. Deterministic scoring engine (no LLM) - see README for how these parameters and the 60% position size were chosen (target: 12%/year). Last updated: 2026-09-02T20:28:23.675293+00:00_

## Current State

- Equity: **169.43 USDT** (started at 100.00)
- Last processed bar: 2026-09-02 20:00:00+00:00
- Position: **flat**
