...
_Simulator only. No real money, no exchange account, no API keys. Entries are judged live by a local Ollama model (qwen2.5:7b), not the fixed rule-based score. **This decision logic is unvalidated / experimental** - see README. Last updated: 2026-09-02T08:56:00.859428+00:00_

## Current State

- Equity: **100.04 USDT** (started at 100.00)
- Last processed bar: 2026-09-02 08:30:00+00:00
- Position: **flat**
